...
public class Pawn extends MovementPiece {
    ...
    public ArrayList<Location> getValidMoves() {
        ...
        validMoves.add(new Location(getLocation().getRow() + (direction * 1), getLocation().getColumn()));
        validMoves.add(new Location(getLocation().getRow() + (direction * 1), getLocation().getColumn() + 1));
        validMoves.add(new Location(getLocation().getRow() + (direction * 1), getLocation().getColumn() - 1));
